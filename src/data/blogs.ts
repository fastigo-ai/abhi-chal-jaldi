  ...
  content: {
    ...
    sections: [
      ...
      },
      {
        ...
        points: [
          { title: "Laptop Screen Replacement", description: "If your screen is cracked, flickering, or completely black, we can replace it with a brand-new one compatible with your model." },
          { title: "Battery Replacement", description: "Is your laptop not holding a charge or shutting down frequently? A battery replacement can solve this issue and improve performance." },
          { title: "Keyboard Repair", description: "Sticky or non-responsive keys can be frustrating. We replace damaged keyboards with genuine ones that work smoothly." },
          { title: "Motherboard Repair", description: "Our experts specialize in motherboard-level repairs, fixing power issues, BIOS errors, and component failures with precision." },
          { title: "Overheating and Fan Issues", description: "Dust and poor ventilation can cause laptops to overheat. We clean the cooling system, apply thermal paste, and ensure smooth airflow." },
          { title: "Data Recovery and Backup", description: "Lost important files? Our data recovery service helps restore deleted or corrupted data safely and securely." },
          { title: "Virus and Malware Removal", description: "If your laptop has become slow or showing pop-ups, we provide complete virus removal and software optimization services." },
          { title: "Software Installation and OS Upgrades", description: "We install or upgrade your operating system, drivers, and other software to keep your laptop updated and secure." },
        ],
      },
      {
    ...
    sections: [
      {
        ...
        points: [
          { title: "Too Many Startup Programs", description: "Many apps automatically launch when you start your laptop. These unnecessary programs use up system memory and slow down boot time." },
          { title: "Low RAM or Old Hard Drive", description: "If your laptop uses an HDD instead of an SSD or has limited RAM, it will struggle to handle modern software and multitasking." },
          { title: "Virus or Malware Infection", description: "Viruses, spyware, and malware often run in the background, consuming CPU resources and affecting performance." },
          { title: "Outdated Software or Drivers", description: "Running outdated operating systems and drivers can cause lag and reduce compatibility with new applications." },
          { title: "Overheating and Dust Build-Up", description: "When your laptop overheats, it slows down to protect internal components. Dust in the fan or vents is a common reason for overheating." },
          { title: "Too Many Background Processes", description: "Apps running in the background—like antivirus scans or updates—can take up memory and CPU, making your system slower." },
          { title: "Corrupted Operating System or Disk Errors", description: "If your OS is corrupted or your hard drive has bad sectors, your system may crash or run very slowly." },
        ],
      },
      {
        heading: "Door2fy – Your Laptop Speed Fix Experts in Noida",
        points: [
          { title: "Doorstep Laptop Repair", description: "We come to your home or office and fix your laptop on-site." },
          { title: "Certified Technicians", description: "Skilled experts with experience in handling all laptop brands." },
          { title: "Transparent Pricing", description: "No hidden costs—only pay for the services you choose." },
          { title: "Fast Service", description: "Most issues fixed within the same day." },
          { title: "Genuine Parts", description: "We use 100% original spare parts for replacements and upgrades." },
        ],
      },
      {
        heading: "Laptop Optimization Services in Noida",
        points: [
          { title: "Full System Diagnosis", description: "We perform a detailed analysis of your laptop’s software and hardware to identify the cause of the slowdown." },
          { title: "Virus and Malware Removal", description: "Our experts use professional tools to remove viruses, spyware, and malicious programs safely—without losing your data." },
          { title: "Hard Drive to SSD Upgrade", description: "Replacing your old HDD with an SSD can make your laptop up to 5x faster. We provide quick SSD installation and data transfer at home." },
          { title: "RAM Upgrade", description: "If your laptop has less than 8GB RAM, we recommend upgrading it to handle multitasking and heavy applications smoothly." },
          { title: "System Cleanup and Optimization", description: "We remove unnecessary files, temporary data, and unused applications to free up space and speed up performance." },
          { title: "Software and Driver Updates", description: "Our team ensures your OS and drivers are updated to the latest versions for better speed and stability." },
          { title: "Cooling System Maintenance", description: "We clean your laptop fan, vents, and apply fresh thermal paste to prevent overheating." },
        ],
      },
      {
        heading: "Brands We Service",
        brands: ["HP", "Dell", "Lenovo", "Acer", "Asus", "Apple MacBook", "MSI", "Samsung"],
      },
      {
      ...
      },
      {
        ...
        table: [
          { service: "Full System Cleanup & Optimization", cost: "₹700 – ₹1,200" },
          ...
          { service: "Complete Performance Tune-up", cost: "₹1,000 – ₹2,500" },
        ],
      },
      {
        heading: "Benefits of Fixing a Slow Laptop Instead of Buying a New One",
        list: [
    ...
    sections: [
      {
        ...
        points: [
          { title: "Doorstep Service", description: "No need to visit a service center or wait in long queues. Book your repair online, and our technician will arrive at your location to diagnose and fix your Lenovo laptop." },
          { title: "Certified Technicians", description: "Our professionals are trained to handle all Lenovo models—IdeaPad, ThinkPad, Yoga, Legion, and others. From software bugs to hardware issues, we fix everything." },
          { title: "Genuine Spare Parts", description: "We use only authentic Lenovo components for replacements such as screens, keyboards, and batteries, ensuring long-lasting performance." },
          { title: "Transparent Pricing", description: "Door2fy believes in honest service. You’ll always receive a detailed quote before any repair begins—no hidden costs." },
          { title: "Quick Turnaround Time", description: "Most issues are resolved on the same day. For complex repairs, we provide regular updates so you’re always informed." },
        ],
      },
      {
        heading: "Common Lenovo Laptop Issues We Fix",
        points: [
          { title: "Lenovo Laptop Not Turning On", description: "If your laptop won’t start, it could be a motherboard, battery, or power jack issue. We perform a quick diagnosis and repair it efficiently." },
          { title: "Slow Performance or Freezing", description: "We optimize the software, clean unwanted files, or recommend RAM/SSD upgrades for better performance." },
          { title: "Screen Replacement", description: "Cracked, flickering, or black screens can be replaced with genuine Lenovo screens to restore your display quality." },
          { title: "Battery or Charging Issues", description: "If your laptop battery drains too fast or doesn’t charge, we replace it with a compatible Lenovo battery." },
          { title: "Keyboard or Touchpad Not Working", description: "We repair or replace faulty keyboards and touchpads so you can get back to work comfortably." },
          { title: "Overheating or Fan Noise", description: "Our experts clean the cooling system, apply new thermal paste, and fix fan-related issues to prevent overheating." },
          { title: "Software & Operating System Issues", description: "From Windows installation to Lenovo driver updates, we handle all software-related repairs." },
          { title: "Virus and Malware Removal", description: "We clean your system from harmful software that may cause slow performance or data loss." },
          { title: "Data Recovery", description: "Accidentally deleted important files? We provide safe and secure data recovery for Lenovo laptops." },
        ],
      },
      {
